...
type Role struct {
	...
	Code      string     `gorm:"column:code;type:varchar(200);not null;default:'';" json:"code"`                                       //
	...
	CreatedAt time.Time  `gorm:"column:created_at;autoCreateTime;type:timestamp;not null;default:CURRENT_TIMESTAMP;" json:"createdAt"` //
	UpdatedAt time.Time  `gorm:"column:updated_at;autoUpdateTime;type:timestamp;not null;default:CURRENT_TIMESTAMP;" json:"updatedAt"` //
